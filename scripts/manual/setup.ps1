...
gh secret set AZURE_RBAC_CREDENTIALS_MANUAL --body "$SERVICE_PRINCIPAL_JSON_STR"
gh secret set REGISTRY_LOGIN_SERVER_MANUAL --body "$CONTAINER_REGISTRY_LOGIN_SERVER"
gh secret set REGISTRY_USERNAME_MANUAL --body "$CLIENT_ID"
gh secret set REGISTRY_PASSWORD_MANUAL --body "$CLIENT_SECRET"
gh secret set FUNCTION_APP_NAME_MANUAL --body "$FUNCTION_APP_NAME"
